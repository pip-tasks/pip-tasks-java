...
ModuleToProcess = 'pip-tasks-java-ps.psm1'

# Version number of this module.
ModuleVersion = '1.0.0.0'

# ID used to uniquely identify this module
GUID = '7a4543b0-452d-49c8-b7a0-cd14b2106a4c'
...
Description = 'Java build tasks for Pip.Tasks'
...
FileList = @('pip-tasks-java-ps.psm1')
